...
//     */
   ...
   public void testPathDistance() {
    ...
    /**
     * test the final points after being scaled to a square 
     */
    @Test
    public void testBox() {
    ...
    public void testCentroid() {
        ...
        assertEquals(new Point(0, 5), recognizer.centerPoint(points));
    }
...
//     */
   ...
   public void testRecognize(){
       ...
       newRecognizer.addTemplate("Arrow", templateGesture);
       newRecognizer.addTemplate("Circle", circleTemplate);


       Deque<Point> testGesture = ioManager.loadGesture("arrowTest.xml");


       HashMap<String,Double> newHashMap  = newRecognizer.bestTemplate(testGesture); 
       Iterator<Double> scoreIterator = newHashMap.values().iterator(); 
       ...
       newRecognizer.addTemplate("Arrow", testGesture); 
       Iterator<Double> newScoreIterator = newRecognizer.bestTemplate(testGesture).values().iterator(); 
       score = newScoreIterator.next(); 
